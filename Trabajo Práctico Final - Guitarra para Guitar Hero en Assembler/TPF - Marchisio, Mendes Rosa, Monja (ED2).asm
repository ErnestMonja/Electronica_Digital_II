; Electronica Digital 2 - Trabajo Practico Final
...
MAIN
    ...
    ;-------------------------------- Transmisión Serie.
    BANKSEL SPBRG
    MOVLW .25		                ; 9600 baudios con 4 [MHz].
    MOVWF SPBRG
...
ADC_ISR                             ; Cada que termina la conversión, compara y maneja el vibrato.
    ...
    GOTO CHECK_VIBRATO_ON           ;           Sino, el vibrato debe estar desactivado.
    MOVF VIBRATO_ACTIVO, F
    BTFSC STATUS, Z	                ; Me fijo si el vibrato estaba en 0.
    RETFIE		                    ; Si VIBRATO_ACTIVO ya era 0, no hacer nada. Si el vibrato estaba activado, lo desactivo.
